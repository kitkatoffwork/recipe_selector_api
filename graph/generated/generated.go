...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateMenu func(childComplexity int, input model.NewMenu) int
	}
...
type MutationResolver interface {
	CreateMenu(ctx context.Context, input model.NewMenu) (*model.Menu, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Menu.text":
		if e.complexity.Menu.Text == nil {
			break
		}

		return e.complexity.Menu.Text(childComplexity), true
	...
	case "Mutation.createMenu":
		...
		return e.complexity.Mutation.CreateMenu(childComplexity, args["input"].(model.NewMenu)), true
...
func (ec *executionContext) field_Mutation_createMenu_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 model.NewMenu
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewMenu2apiᚋgraphᚋmodelᚐNewMenu(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Menu_text(ctx context.Context, field graphql.CollectedField, obj *model.Menu) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_createMenu(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateMenu(rctx, args["input"].(model.NewMenu))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewMenu(ctx context.Context, obj interface{}) (model.NewMenu, error) {
	var it model.NewMenu
...
func (ec *executionContext) _Menu(ctx context.Context, sel ast.SelectionSet, obj *model.Menu) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "text":
			out.Values[i] = ec._Menu_text(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNMenu2apiᚋgraphᚋmodelᚐMenu(ctx context.Context, sel ast.SelectionSet, v model.Menu) graphql.Marshaler {
...
func (ec *executionContext) unmarshalNNewMenu2apiᚋgraphᚋmodelᚐNewMenu(ctx context.Context, v interface{}) (model.NewMenu, error) {
	return ec.unmarshalInputNewMenu(ctx, v)
}
